...
class ViewController: UIViewController {
    ...
    @IBAction func showSecondView(_ sender: Any) {
        if switchForViews.isOn {
            ...
            if let secView = storyboard?.instantiateViewController(identifier: "SecondViewController") as? SecondViewController {
            ...
            let titleForSecView = textField.text
            let secView = storyboard!.instantiateViewController(identifier: "SecondViewController") as! SecondViewController
//            secView?.title = titleForSecView
            secView.titleText = titleForSecView
